...
public class CatalogServiceTest
{
    ...
    public async Task GetCatalogItemsAsync_Failed()
    {
        ...
        _catalogItemRepository.Setup(s => s.GetByPageAsync(
            It.Is<int>(i => i == testPageIndex),
            It.Is<int>(i => i == testPageSize))).Returns((Func<GetItemsResponse<CatalogItemDto>>)null!);
    ...
    [Fact]
    public async Task GetItemsByIdAsync_Success()
    {
        var testId = 1;
    ...
    [Fact]
    public async Task GetItemsByIdAsync_Failed()
    {
        // arrange
        var testId = 1000;

        _catalogItemRepository.Setup(s => s.GetByIdAsync(
            It.Is<int>(i => i == testId))).Returns((Func<GetItemsResponse<CatalogItemDto>>)null!);
    ...
    public async Task GetItemsByBrandAsync_Failed()
    {
        ...
        _catalogItemRepository.Setup(s => s.GetByBrandAsync(
            It.Is<int>(i => i == testBrandId))).Returns((Func<BrandsResponse<CatalogItemDto>>)null!);
    ...
    public async Task GetItemsByTypeAsync_Failed()
    {
        ...
        _catalogItemRepository.Setup(s => s.GetByTypeAsync(
            It.Is<int>(i => i == testTypeId))).Returns((Func<TypesResponse<CatalogItemDto>>)null!);
